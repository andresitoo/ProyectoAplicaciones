function validacions() {
    ...
    { 
        ...
        window.open('WebPage/Seguridad/index.html','','toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=no, width=1024, height=640, left=0, target="_blank", top=0');
        }
