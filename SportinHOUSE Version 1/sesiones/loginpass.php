	...
	<div class="header1">
	   <div class="container">
		  <div class="header-text">
            ...
            <form name="ingreso" action="../webpage/seguridad/objetos/validarPass.php" method="post">
           
						  <fieldset class="input">
						  <<p id="login-form-username">
						      <label for="modlgn_username" class="user">User</label>

						      <input id="usuario"  disabled="disabled" type="text" value="<?php echo $_SESSION['usuario']; ?>" name="usuario" class="inputbox" size="18" >
						    					    </p> 
